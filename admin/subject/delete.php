...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">    
    ...
    <div class="row mt-5">
        <form method="POST" action="" class="border border-secondary-1 p-5 mb-4">
            <div class="mb-2">
                <label class="form-label fs-5">Are you sure you want to delete the following subject record?</label> 
                ...
                <div>
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Delete Subject Record</button>
                </div>  
            </div>
        </form>
    </div>    
